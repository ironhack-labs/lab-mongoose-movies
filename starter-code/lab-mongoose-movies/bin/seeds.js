...
const celebrities = [
  {
    ...
    occupation: "actor",
    catchPhrase:
      "Sorry boss, but there is only two men I trust. One of them is me. The other is not you."
  },
  {
    name: "Robert De Niro",
    occupation: "actor",
    catchPhrase:
      "Time goes on. So whatever you are going to do, do it. Do it now. Do not wait"
  },
  {
    name: "Bob Marley",
    occupation: "singer",
