...
const celebrities = [
  {
    name: "Chris Pratt",
    occupation: "Actor",
    catchPhrase: "I like to do 'Garfield Mondays': lasagna and napping in a box."
  },
  {
    name: "Benedict Cumberbatch",
    occupation: "Actor",
    catchPhrase: "I keep myself amused and others confused"
  },
  {
    name: "Robert Downey Jr.",
    occupation: "Actor",
    catchPhrase: "Listen, smile, agree, and then do whatever the f*&k you were gonna do anyway."
  }
]
