...
Celebrity.insertMany(celebrities)
  .then(success => {
    console.log("Celebrity - SEEDED DB SUCCESSFULLY !");
  })
  .catch(error => {
    console.log("Celebrity - ERROR WHILE SEEDING THE DB !")
  })

Movie.insertMany(movies)
  .then(success => {
    console.log("Movie - SEEDED DB SUCCESSFULLY !");
  })
  .catch(error => {
    console.log("Movie - ERROR WHILE SEEDING THE DB !")
  })
